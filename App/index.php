...
$app->route->add('/admin/users/:id', 'Admin/Users@show');
...
$app->route->add('/admin/posts/:id', 'Admin/Posts@show');
...
$app->route->add('/admin/posts/comments/edit/:id', 'Admin/Comments@edit');
$app->route->add('/admin/posts/comments/save/:id', 'Admin/Comments@save','POST');
$app->route->add('/admin/posts/comments/delete/:id', 'Admin/Comments@save');
...
$app->route->add('/admin/categories/:id', 'Admin/Categories@show');
...
$app->route->add('/admin/contacts/replay/:id', 'Admin/Contacts@reply');
